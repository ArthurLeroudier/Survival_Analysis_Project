...
cumhaz <- data.frame(time = cbind(max(fitYes$time[1],fitNo$time[1]):max(fitYes$time[-1],fitNo$time[-1])))

cumhazYes <- data.frame(time = fitYes$time, cumhaz = fitYes$cumhaz)
cumhazNo <- data.frame(time = fitNo$time, cumhaz = fitNo$cumhaz)

cumhazYes$time[cumhazYes$time<=max(fitYes$time[1], fitNo$time[1])] = max(fitYes$time[1], fitNo$time[1])
cumhazNo$time[cumhazNo$time<=max(fitYes$time[1], fitNo$time[1])] = max(fitYes$time[1], fitNo$time[1])
